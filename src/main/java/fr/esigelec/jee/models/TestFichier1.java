...
public class TestFichier1 {
	...
	final static String nomTable = "prelevement";
			...
			do {
				...
				try {
					...
					if (ligne != null) {
						...
						String requete = "insert into " + nomTable + " (cdreseau,inseecommuneprinc,nomcommune,referenceprel,conclusionprel,cdept) values (?,?,?,?,?,?)";
