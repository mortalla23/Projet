...
public class TestFichier3 {
	...
	final static String nomFichier = "C:\\Users\\acer\\OneDrive\\Bureau\\Isn\\FichierProjet (2)\\FichierProjet\\Fichier\\commune.csv";

	// caractère de séparation des colonne
	final static String separateur = ";";
	final static String nomTable = "commune";
			...
			do {
				...
				try {
					...
					if (ligne != null) {
						...
						String requete = "insert into " + nomTable + " (insee,nomcommune,codepostal) values (?,?,?)";
