...
public class TestFichier2 {
	...
	final static String nomFichier = "C:\\Users\\acer\\OneDrive\\Bureau\\DIS_RESULT_20241.txt";

	// caractère de séparation des colonne
	final static String separateur = ",";
	final static String nomTable = "resultats";
			...
			do {
				...
				try {
					...
					if (ligne != null) {
						...
						String requete = "insert into " + nomTable + " (cddept,referenceprel,libMinParametre,cdunitereference,refqual) values (?,?,?,?,?)";
						...
						stmt.setString(3, tab[5]);
						stmt.setString(4, tab[10]);
						stmt.setString(5, tab[13]);
